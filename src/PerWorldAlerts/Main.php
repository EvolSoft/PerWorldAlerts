...
class Main extends PluginBase{
    ...
    public function onEnable(){
        ...
        $this->logger->info($this->translateColors("&", Main::PREFIX . "&ePerWorldAlerts &bv" . Main::VERSION . " &edeveloped by&b " . Main::PRODUCER));
        $this->logger->info($this->translateColors("&", Main::PREFIX . "&eWebsite &b" . Main::MAIN_WEBSITE));
	    $this->getServer()->getPluginManager()->registerEvents(new EventListener($this), $this);
    }
    
    public function SendLevelAlert($level, $message){
    ...
    public function isAlertDisabled($level){
    	$level = strtolower($level);
    	$tmp = $this->getConfig()->getAll();
    	$ltmp = array();
